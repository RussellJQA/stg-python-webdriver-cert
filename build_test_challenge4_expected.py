""" This module creates a .json file containing the Fibonacci sequence of the maximum length
    supported by the Fibonacci class, with the numbers of the sequence
    (0, 1, 1, 2, 3, ...) converted to words 
...
# Generate the expected sequence, in words, using a slight different format then num2words.
...
#   "twelve billion, five hundred eighty six million, two hundred sixty nine thousand and twenty five",
