"""
This module contains some functions for interacting with the pytest test framework
"""
...
def get_current_pytest_test_name() -> str:
    ...
    #   challenges/test_challenge6.py::test_search_for_given_make_and_model (call)
    # the current pytest test name is just "test_search_for_given_make_and_model"
